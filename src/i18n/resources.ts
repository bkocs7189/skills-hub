export const resources = {
  en: {
    translation: {
      ...
      assetTypeMcpServer: 'MCP Server',
      assetTypePlugin: 'Plugin',
      assetTypeExecutable: 'Executable',
      securityTrusted: 'Trusted',
      securityUnknown: 'Unknown Source',
      securityFlagged: 'Flagged',
      securityCheck: 'Security Check',
      securityTier1: 'Quick Check',
      securityTier2: 'Deep Scan',
      securityPassed: 'All checks passed',
      securityIssuesFound: '{{count}} issues found',
      securityRunDeepScan: 'Run Deep Scan',
      securityTrustedPublisher: 'Trusted Publisher',
      securityKnownSource: 'Known Source',
      securityUnknownSource: 'Unknown Source',
      securitySeverityHigh: 'High',
      securitySeverityMedium: 'Medium',
      securitySeverityLow: 'Low',
      securityManageTrusted: 'Manage Trusted Publishers',
      ...
      mcpImportServers: 'Import MCP Servers',
      mcpImportSuccess: 'Imported {{count}} MCP servers',
      mcpServerName: 'Server Name',
      mcpServerCommand: 'Command',
      mcpServerArgs: 'Arguments',
      mcpServerEnv: 'Environment Variables',
      mcpEnvKey: 'Key',
      mcpEnvValue: 'Value',
      mcpAddEnvVar: 'Add Variable',
      mcpSyncToTool: 'Sync to Tool',
      mcpUnsyncFromTool: 'Remove from Tool',
      mcpNoServers: 'No MCP servers configured',
      pluginsTitle: 'Plugins',
      pluginImport: 'Import Plugins',
      pluginImportSuccess: 'Imported {{count}} plugins',
      pluginDiagnose: 'Diagnose Plugins',
      pluginHealthy: 'Healthy',
      pluginUnhealthy: 'Issues Found',
      pluginMissing: 'Install path missing',
      pluginNoPluginMd: 'Missing PLUGIN.md',
      ...
      libraryUrl: 'URL',
      libraryType: 'Type',
      libraryTypeMarketplace: 'Marketplace',
      libraryTypeGithub: 'GitHub Repository',
      libraryTypeCurated: 'Curated List',
      libraryManage: 'Manage Libraries',
      libraryDelete: 'Remove Library',
      librarySearch: 'Search libraries...',
      libraryItemCount: '{{count}} items',
      libraryTrusted: 'Trusted',
      deployProfiles: 'Deploy Profiles',
      deployProfileName: 'Profile Name',
      deployProfileDefault: 'Default',
      deployProfileSetDefault: 'Set as Default',
      deployProfileAdd: 'Add Profile',
      deployProfileDelete: 'Delete Profile',
      deployProfileRules: 'Auto-sync targets',
      deployProfileSkillTargets: 'Skill targets',
      deployProfileMcpTargets: 'MCP Server targets',
      deployProfilePluginTargets: 'Plugin targets',
      deployProfileNoProfiles: 'No deploy profiles configured',
      tools: {
        opencode: 'OpenCode',
  ...
  zh: {
    translation: {
      ...
      filterAll: '全部',
      filterSkills: '技能',
      filterMcpServers: 'MCP 服务',
      filterPlugins: '插件',
      filterExecutables: '可执行文件',
      assetTypeSkill: '技能',
      assetTypeMcpServer: 'MCP 服务',
      assetTypePlugin: '插件',
      assetTypeExecutable: '可执行文件',
      securityTrusted: '已信任',
      securityUnknown: '未知来源',
      securityFlagged: '已标记',
      securityCheck: '安全检查',
      securityTier1: '快速检查',
      securityTier2: '深度扫描',
      securityPassed: '所有检查通过',
      securityIssuesFound: '发现 {{count}} 个问题',
      securityRunDeepScan: '运行深度扫描',
      securityTrustedPublisher: '可信发布者',
      securityKnownSource: '已知来源',
      securityUnknownSource: '未知来源',
      securitySeverityHigh: '高',
      securitySeverityMedium: '中',
      securitySeverityLow: '低',
      securityManageTrusted: '管理可信发布者',
      allSkills: '全部 Skills',
      sortUpdated: '最近更新',
      sortName: '名称 A–Z',
      ...
      mcpImportServers: '导入 MCP 服务',
      mcpImportSuccess: '已导入 {{count}} 个 MCP 服务',
      mcpServerName: '服务名称',
      mcpServerCommand: '命令',
      mcpServerArgs: '参数',
      mcpServerEnv: '环境变量',
      ...
      mcpAddEnvVar: '添加变量',
      mcpSyncToTool: '同步到工具',
      mcpUnsyncFromTool: '从工具移除',
      mcpNoServers: '未配置 MCP 服务',
      pluginsTitle: '插件',
      pluginImport: '导入插件',
      pluginImportSuccess: '已导入 {{count}} 个插件',
      pluginDiagnose: '诊断插件',
      pluginHealthy: '健康',
      pluginUnhealthy: '发现问题',
      pluginMissing: '安装路径缺失',
      pluginNoPluginMd: '缺少 PLUGIN.md',
      marketplacesTitle: '插件市场',
      librariesTitle: '资源库',
      libraryAdd: '添加资源库',
      libraryName: '资源库名称',
      libraryUrl: '地址',
      libraryType: '类型',
      libraryTypeMarketplace: '插件市场',
      libraryTypeGithub: 'GitHub 仓库',
      libraryTypeCurated: '精选列表',
      libraryManage: '管理资源库',
      libraryDelete: '移除资源库',
      librarySearch: '搜索资源库...',
      libraryItemCount: '{{count}} 项',
      libraryTrusted: '已信任',
      deployProfiles: '部署配置',
      deployProfileName: '配置名称',
      deployProfileDefault: '默认',
      deployProfileSetDefault: '设为默认',
      deployProfileAdd: '添加配置',
      deployProfileDelete: '删除配置',
      deployProfileRules: '自动同步目标',
      deployProfileSkillTargets: '技能目标',
      deployProfileMcpTargets: 'MCP 服务目标',
      deployProfilePluginTargets: '插件目标',
      deployProfileNoProfiles: '未配置部署配置',
      tools: {
        opencode: 'OpenCode',
        claude_code: 'Claude Code',
        codex: 'Codex',
